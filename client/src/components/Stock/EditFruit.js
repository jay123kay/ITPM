...
export default class EditFruit extends Component {
  ...
  onSubmit = (e) =>{
    ...
    axios.put(`/fruit/update/${id}`,data).then((res) =>{
      if(res.data.success){
  ...
  componentDidMount(){
    ...
    axios.get(`/fruit/${id}`).then((res) =>{
      if(res.data.success){
        this.setState({
          name:res.data.fruit.name,
          uPrice:res.data.fruit.uPrice,
          quantity:res.data.fruit.quantity,
          inValue:res.data.fruit.inValue,
          mDate:res.data.fruit.mDate,
          eDate:res.data.fruit.eDate
        });
